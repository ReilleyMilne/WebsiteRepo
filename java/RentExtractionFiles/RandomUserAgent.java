// Source of code: https://github.com/mkstayalive/random-user-agent-java/tree/master
...
public class RandomUserAgent {
	...
	static {
		...
		// freqMap.put("Firefox", 28.2); //28.2
		freqMap.put("Chrome", 100.0); // 52.9
		// freqMap.put("Safari", 3.9); //3.9
		// freqMap.put("Opera", 1.8); //1.8
